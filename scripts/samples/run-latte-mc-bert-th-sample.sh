...
NUM_GPUS=1
DATA_DIR=data/samples/th
EXT_DIC_FILE=data/dict/samples/hse-thai-lexitron.vocab.sample.sl
PRETRAINED_MODEL=data/ptm/bert-base-multilingual-cased
# PRETRAINED_MODEL=bert-base-multilingual-cased
SAVE_DIR=models/samples
MODEL_NAME=latte-mc-bert-base-thai-ws-sample
MODEL_VERION=99
BATCH_SIZE=4
MAX_EPOCHS=2
ACC_GRAD_BATCH=1
...
METRIC_TYPE=word-bin
RUN_MODE=latte
PRETRAINED_SAVE_PATH=pretrained/samples/$MODEL_NAME
SEED=112
